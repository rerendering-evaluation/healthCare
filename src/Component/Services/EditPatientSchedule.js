...
function EditPatientSchedule() {
  ...
  const {addPatient,updateIndex,setDataResult,dataResult}=contextData;
...
<form onSubmit={handleSubmit(onSubmit)}>
      ...
      <TextField id="outlined-basic" variant="outlined" label="Patient No" disabled type="text" size="small" className='w-60' 
  defaultValue={addPatient.PatientNo}
  {...register("PatientNo")} />
      <TextField id="outlined-basic" variant="outlined" label="PatientName" disabled type="text" size="small" className='w-60' 
  defaultValue={addPatient.PatientName}
  {...register("PatientName")} />
      <TextField id="outlined-basic" variant="outlined" label="Mobile No" disabled type="text" size="small" className='w-60' 
  defaultValue={addPatient.MobileNo}
  {...register("MobileNo")} />
  ...
  <TextField id="outlined-basic" variant="outlined" label="EntryDate" disabled type="text" size="small" className='w-60' 
  defaultValue={addPatient.EntryDate}
  {...register("EntryDate")} />

<TextField id="outlined-basic" variant="outlined" label="Entry Timing" disabled type="text" size="small" className='w-60'
defaultValue={addPatient.Timing}
{...register("Timing")}/>
</div>
<div className='mx-3 mt-10 ml-20 flex gap-40 '>
<TextField id="outlined-basic" variant="outlined" label="Doctor Assigned" type="text" size="small" className='w-60' 
  defaultValue={addPatient.Doctor}
  {...register("Doctor")}/>
<TextField id="outlined-basic" variant="outlined" label="Doctor Services" type="text" size="small" className='w-60' 
  defaultValue={addPatient.DoctServices}
