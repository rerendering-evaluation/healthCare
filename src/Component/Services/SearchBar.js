...
function SearchBar() {
    ...
    const {filterData,value,}=contextData;
  ...
  return (
    <div>
     ...
     <div className='flex gap-5 mt-4 md:mt-0'>
         <div>
         <TextField id="outlined-basic" label="Search by Patient-Name" variant="outlined"  value={value}
   onChange={filterData} size='small'
    className='md:w-96 md:h-10 w-40  bg-white border-gray-500'/>
            </div>
