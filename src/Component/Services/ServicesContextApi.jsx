...
const filertablefunc = (value) => {
    let newData = data.result.filter(
          datarow =>
          datarow.PatientName.toLowerCase().includes(value.toLowerCase()) ||
          datarow.Doctor.toLowerCase().includes(value.toLowerCase()) ||
          datarow.DoctServices.toLowerCase().includes(value.toLowerCase())
    )
    return newData
}
