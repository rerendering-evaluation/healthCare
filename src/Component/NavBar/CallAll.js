...
import { BrowserRouter as Router, Route, Link, Routes, NavLink, useLocation
    ...
    {/* <Router> */}
      ...
      <p className="text-xl font-semibold tracking-wide">Call All :-</p>
        ...
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600">
          <NavLink to='/'  className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')}>Home</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/Appointment' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >Appointment</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/AppJs/ServiceCreation/' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >ServiceCreation</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/AppJs/SuperMaster/' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >SuperMaster</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/AppJs/TryingCommon/' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >TryingCommon</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/AppJs/TryingFire/' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >TryingFire</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/Billing' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >Billing</NavLink></li>
        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600"><NavLink to='/EMR' className={({ isActive }) => (isActive ? 'text-cyan-600' : 'inactive')} >EMR</NavLink></li>
      </ul>
        <Routes>
