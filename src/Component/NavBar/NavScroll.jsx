  ...
  return (
    ...
    <Box className='shadow-inner z-50'>
      <div className='  mx-auto justify-center w-[100%] z-50 shadow-2xl'>
        <div className={classNames(isVisible ? 'w-[100%]  fixed mx-auto justify-center z-50  transition ease-in-out delay-200 duration-300 ' : '  w-[100%] z-50 shadow-9xl ', 'z-50 top-0 w-full')}>
            {/*  */}
            <div className='lg:w-[100%] w-[100%] h-[80px] z-50  drop-shadow-lg justify-center mx-auto items-center  sm:pr-0 bg-white'>
                              ...
                              return <div key={indexf}>
                                        ...
                                        return <div key={indexS}>
                                                                        ...
                                                                        <li className="underline underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600">
                                                                          <NavLink to={smenu.routerLink} className={({
                                      isActive
                                    }) => isActive ? 'text-cyan-600' : 'inactive'}>{smenu.subHead}</NavLink>
                                                                        </li>
                                                                        {/* <li  className="">
                                        ...
                                        <div className="py-10">
                                            <div className="dropdown inline-block relative group">
                                              <div className=" underline-offset-4 decoration-4 hover:decoration-cyan-600 hover:text-lg hover:text-cyan-600 font-semibold tracking-wide text-base">
                                                  <NavLink to={item.routerLink} className={({
                              isActive
                            }) => isActive ? 'text-cyan-500' : 'text-black'}>{item.head}</NavLink>
                                              </div>
                                            </div>
                                        </div>
                                    </div>}
              ...
              <ul className={!nav ? 'hidden' : 'flex flex-col bg-white w-[100%] sm:w-[75%] px-8 lg:hidden overflow-y-scroll overflow-x-hidden mx-auto h-fit max-h-[500%] z-50 '}>
                ...
                console.log(window.globalCount++);
                return <div key={indexT} className='z-50'> 
                          {/* only head */}
                            {item.subMenus ? <div>
                      ...
                      {/*  */}
                                            ...
                                            {/*  */}
                                            {item.expand === false ? <PlusIcon className='w-4 transform delay-500 duration-500  text-zinc-600 ' /> : <div><MinusIcon className='w-4 text-zinc-600  transform delay-500 duration-500' /></div>}
                                            </div>
                                    </li>
                                  {/* head inner contents */}
                                  {item.expand === true ? <div className=''>
                      ...
                      {/*  */}
                                                      ...
                                                      {smenu.sExpand === false ? <PlusIcon className='w-4 transform delay-500 duration-500  text-zinc-600 ' /> : <div><MinusIcon className='w-4 text-zinc-600  transform delay-500 duration-500' /></div>}
                                                      </div>
                                                    </li>


                                                    {smenu.sExpand === true ? <div>
                                                          <ul className=' bg-white pl-8 lg:hidden'>
                                                            {smenu.subSubMenu && smenu.subSubMenu.map((sSubmenu, smindex) => {
                                    console.log(window.globalCount++);
                                    return <div key={smindex}>
                                                    ...
                                                    </div> : <li onClick={handleClose} className='py-2     border-b border-zinc-200 w-full'>{smenu.subHead}</li>}
                                              </div>;
                        })}
                                        </ul>
                                      </div> : <div>
                                ...
                                <div className='py-2 flex border-b border-zinc-200 w-full'>
                                      <NavLink to={item.routerLink} onClick={handleClose} className={({
                        isActive
                      }) => isActive ? 'text-blue-800' : 'text-black'}>{item.head}</NavLink>
                                </div>
                                </>}
                        </div>
                // end
